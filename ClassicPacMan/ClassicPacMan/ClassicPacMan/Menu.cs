...
namespace ClassicPacMan
{
    ...
    public class Menu : DrawableGameComponent
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (gameStart_)
            {
                soundBank_.PlayCue(SoundBank.SoundTitle.NewGame);
                gameStart_ = false;
            }
            ...
            var newPressedKeys = from k in newState.GetPressedKeys()
                                         ...
                                         select k;
#else
            Keys[] newPressedKeys = {Keys.Z};
            newPressedKeys[0] = GamePadHelper.currentKey(PlayerIndex.One);
            if (_lastKey == newPressedKeys[0])
                return;
            _lastKey = newPressedKeys[0];
            ...
            if (newPressedKeys.Contains(Keys.Down))
            {
                ...
                soundBank_.PlayCue(SoundBank.SoundTitle.PacManEat1);
            }
            else if (newPressedKeys.Contains(Keys.Up))
            {
                selection_--;
                selection_ = (selection_ < 0 ? items_.Length - 1 : selection_);
                soundBank_.PlayCue(SoundBank.SoundTitle.PacManEat2);
            }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            // Draw items
            var itemPosition = new Vector2(0, 0);
        ...
        public static void SaveHighScore(int highScore)
        {
            ...
            {
                File.WriteAllLines(fileName, new[] {highScore.ToString()});
            }
            else
            {
