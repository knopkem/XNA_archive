...
namespace ClassicPacMan
{
    ...
    internal static class Constants
    {
        ...
        public static readonly Position startPositionBlinky = new Position
                                                                  {
                                                                      Tile = new Point(13, 11),
                                                                      DeltaPixel = new Point(8, 0)
                                                                  };

        public static readonly Position startPositionPinky = new Position
                                                                 {
                                                                     Tile = new Point(13, 14),
                                                                     DeltaPixel = new Point(8, 8)
                                                                 };

        public static readonly Position startPositionInky = new Position
                                                                {Tile = new Point(11, 13), DeltaPixel = new Point(8, 8)};

        public static readonly Position startPositionClyde = new Position
                                                                 {
        ...
        private static readonly int[] cruiseElroyTimers_ = {20, 30, 40, 40, 40, 50, 50, 50, 60, 60};
        private static readonly int[] blueTimes_ = {6, 6, 4, 3, 2, 6, 2, 2, 1, 5, 2, 1, 1, 3, 1, 1, 0, 1, 0, 0, 0};

        private static readonly int[] bonusScores_ = {
                                                         100, 300, 500, 700, 700, 1000, 1000, 2000, 2000, 3000, 3000, 5000,
                                                         5000, 5000
                                                     };

        private static readonly string[] bonusSprites_ = {
                                                             "Cherry", "Strawberry", "Apple", "Bell", "Orange", "Pear",
                                                             "Pretzel", "Bell", "Banana", "Key", "Key"
                                                         };
